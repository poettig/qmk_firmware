...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYER3] = LAYOUT_preonic_grid(
        ...
        ___X___,  UM(ELLIPSIS),  LSFT(KC_SLASH), RALT(KC_8),    RALT(KC_9),    KC_GRAVE,      LSFT(KC_1),    KC_NUBS,    LSFT(KC_NUBS), LSFT(KC_0),    LSFT(KC_6),    ___X___,
        ___X___,  RALT(KC_MINS), LSFT(KC_7),     RALT(KC_7),    RALT(KC_0),    LSFT(KC_RBRC), LSFT(KC_MINS), LSFT(KC_8), LSFT(KC_9),    KC_SLSH,       LSFT(KC_DOT),  RALT(KC_Q),
        ___X___,  KC_NUHS,       LSFT(KC_4),     RALT(KC_NUBS), RALT(KC_RBRC), LSFT(KC_EQL),  KC_RBRC,       LSFT(KC_5), LSFT(KC_2),    LSFT(KC_NUHS), LSFT(KC_COMM), KC_RSFT,
    ...
    [_LOWER] = LAYOUT_preonic_grid(
        ...
        ___X___, ___X___, KC_MINS, ___X___, ___X___, ___X___, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_BSPC, KC_PSCR,
        ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, KC_HOME, KC_PGDN, KC_PGUP, KC_END,   ___X___, ___X___,
        ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, KC_MNXT, KC_VOLD,  KC_VOLU, KC_MPLY
    ),

    [_RAISE] = LAYOUT_preonic_grid(
        ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___,
        ___X___, KC_F1,   KC_F2,   KC_F3,   KC_F4,   ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___,
        ___X___, KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_BTN2, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_WH_U, KC_WH_D,
        ___X___, KC_F9,   KC_F10,  KC_F11,  KC_F12,  ___X___, ___X___, KC_F13,  KC_F14,  KC_F15,  KC_F16,  ___X___,
        ___X___, ___X___, ___X___, ___X___, ___X___, KC_BTN1, KC_BTN2, ___X___, ___X___, ___X___, ___X___, ___X___
    ),

    [_ADJUST] = LAYOUT_preonic_grid(
        KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
        ___X___, QK_BOOT, DB_TOGG, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, KC_DEL,
        ___X___, ___X___, ___X___, ___X___, ___X___, AU_TOGG, MU_TOGG, EEGG,    ___X___, ___X___, ___X___, ___X___,
        ___X___, ___X___, ___X___, ___X___, ___X___, CK_TOGG, CK_UP,   CK_DOWN, CK_RST,  ___X___, ___X___, ___X___,
        ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___, ___X___
    )
